...
from . import AngTransf as geo
from . import TaylorF2 as Tf2
from . import IMRPhenomA as phnA
from . import IMRPhenomB as phnB
from . import IMRPhenomC as phnC
from . import IMRPhenomD as phnD
from . import IMRPhenomHM as phnHM
